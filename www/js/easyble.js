...
(function (tisensortag) {
    var EasyBLE = (function () {
        function EasyBLE() {
            this.reportDeviceOnce = false;
            this.readCounter = 0;
            this.internal = new tisensortag.InternalClass();
        }
        return EasyBLE;
    })();
    ...
    var InternalClass = (function () {
        function InternalClass() {
            this.addMethodsToDeviceObject = function (device) {
    ...
    tisensortag.InternalClass = InternalClass;
